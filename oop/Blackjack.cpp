...
#include <vector>
#include <utility>
std::string checkcards (std::vector<std::pair<int,std::string>> x){
bool f=1,l=1,k=1;
    for (int i=0;i<x.size();i++){
//        if(x[i].first<2||x[i].first>14){
//        if (x[i].second!="rosu"||x[i].second!="negru" ||x[i].second!="romb"||x[i].second!="trefla")
...
if(f) return "Pachet OK"; 
        }else
        if ((x[i].second=="rosu"||x[i].second=="negru" ||x[i].second=="romb"||x[i].second=="trefla")&&(x[i].first>=2&&x[i].first<=14)){

        }else{
            if (x[i].second!="rosu"||x[i].second!="negru" ||x[i].second!="romb"||x[i].second!="trefla") return "Pachet masluit";
            if(x[i].first<2||x[i].first>14) return "Pachet masluit";
        }
...
std::vector<std::pair<int,std::string>>  lcg(int a1,int c1,int x01,int a2,int c2,int x02){
    std::vector<std::pair<int,std::string>> v;
    v.push_back(std::make_pair(2,"rosu"));
    v.push_back(std::make_pair(3,"rosu"));
    v.push_back(std::make_pair(4,"rosu"));
    v.push_back(std::make_pair(5,"rosu"));
    v.push_back(std::make_pair(6,"rosu"));
    v.push_back(std::make_pair(7,"rosu"));
    v.push_back(std::make_pair(8,"rosu"));
    v.push_back(std::make_pair(9,"rosu"));
    v.push_back(std::make_pair(10,"rosu"));
    v.push_back(std::make_pair(12,"rosu"));
    v.push_back(std::make_pair(13,"rosu"));
    v.push_back(std::make_pair(14,"rosu"));
    v.push_back(std::make_pair(2,"negru"));
    v.push_back(std::make_pair(3,"negru"));
    v.push_back(std::make_pair(4,"negru"));
    v.push_back(std::make_pair(5,"negru"));
    v.push_back(std::make_pair(6,"negru"));
    v.push_back(std::make_pair(7,"negru"));
    v.push_back(std::make_pair(8,"negru"));
    v.push_back(std::make_pair(9,"negru"));
    v.push_back(std::make_pair(10,"negru"));
    v.push_back(std::make_pair(12,"negru"));
    v.push_back(std::make_pair(13,"negru"));
    v.push_back(std::make_pair(14,"negru"));
    v.push_back(std::make_pair(2,"romb"));
    v.push_back(std::make_pair(3,"romb"));
    v.push_back(std::make_pair(4,"romb"));
    v.push_back(std::make_pair(5,"romb"));
    v.push_back(std::make_pair(6,"romb"));
    v.push_back(std::make_pair(7,"romb"));
    v.push_back(std::make_pair(8,"romb"));
    v.push_back(std::make_pair(9,"romb"));
    v.push_back(std::make_pair(10,"romb"));
    v.push_back(std::make_pair(12,"romb"));
    v.push_back(std::make_pair(13,"romb"));
    v.push_back(std::make_pair(14,"romb"));
    v.push_back(std::make_pair(2,"trefla"));
    v.push_back(std::make_pair(3,"trefla"));
    v.push_back(std::make_pair(4,"trefla"));
    v.push_back(std::make_pair(5,"trefla"));
    v.push_back(std::make_pair(6,"trefla"));
    v.push_back(std::make_pair(7,"trefla"));
    v.push_back(std::make_pair(8,"trefla"));
    v.push_back(std::make_pair(9,"trefla"));
    v.push_back(std::make_pair(10,"trefla"));
    v.push_back(std::make_pair(12,"trefla"));
    v.push_back(std::make_pair(13,"trefla"));
    v.push_back(std::make_pair(14,"trefla"));
int x1,x2;
    for (int i=0;i<50;i++){
    x1=(a1*x01+c1)% 48;
    x2=(a2*x02+c2)% 48;
...
while (std::cin>>c){
    ...
    std::cin>>s;
    //std::cout<<s<<std::endl;
    std::pair<int,std::string> Carte(c,s);
    x.push_back(Carte);
}

   std::cout<<checkcards(x)<<std::endl;
}else
if(cr=="shuffle_cards"){
    int a1,c1, x01, a2, c2, x02, m=0;
    std::cin>>a1>>c1>>x01;
    std::cin>>a2>>c2>>x02;
    while (std::cin>>c){
        getchar();
    ...
    for (int i=0;i<50;i++){
        x1=(a1*x01+c1)% m;
        x2=(a2*x02+c2)% m;
       // std::pair<int,std::string> Carte=x[x1];
        x[x1].swap(x[x2]);
        //x[x2]=Carte;
        x01=x1;
        x02=x2;
